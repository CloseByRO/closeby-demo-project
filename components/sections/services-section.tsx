...
export function ServicesSection({ config }: { config: ClientConfig }) {
  return (
    <section id="servicii" className="py-24 px-6 lg:px-10 bg-cream">
      <div className="max-w-[1200px] mx-auto">
        <div className="mb-14">
          <span className="text-xs font-medium tracking-[0.1em] uppercase text-sage-d">Servicii</span>
          <h2 className="font-serif text-4xl md:text-5xl font-medium text-ink mt-3 mb-3">
            {config.content.servicesTitle}
          </h2>
            ...
            <div
              ...
              className={cn(
                ...
                service.featured
                  ...
                  : 'bg-white border-sage-l/30 hover:border-sage-l hover:shadow-[0_12px_36px_rgba(122,158,135,0.15)] hover:-translate-y-1'
              )}
            >
              {/* Icon */}
              <div
              ...
              <p
                className={cn(
                  ...
                  service.featured ? 'text-white/70' : 'text-ink-l'
                )}
              >
                {service.description}
              </p>
                ...
                <div>
                  <div
                    className={cn(
                      ...
                      service.featured ? 'text-white' : 'text-sage-d'
                    )}
                  >
                  ...
                  <div
                    className={cn(
                      'text-xs mt-0.5',
                      service.featured ? 'text-white/50' : 'text-ink-xl'
                    )}
                  >
