...
/**
 * @param {{ services: Array<{ title: string; duration: number; price?: number; currency: string; calEventSlug: string; icon: string }>; integrations: { calComCanonicalEventSlugs?: Record<EventSlugKey, string>; calComEventSlugs?: Record<EventSlugKey, string> } }} config
